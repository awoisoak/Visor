...
public class PhotoActivity extends AppCompatActivity {
    ...
    @BindView(R.id.photo_activity_image_view) ImageView mImageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            mPhoto = bundle.getString(EXTRA_IMAGE);
        } else {
            Log.e(MARKER, "unknown postID!");
        }
        Glide.with(this).load(mPhoto).error(R.drawable.hal_9000).placeholder(R.drawable.gradient).crossFade(1000).into(mImageView);
